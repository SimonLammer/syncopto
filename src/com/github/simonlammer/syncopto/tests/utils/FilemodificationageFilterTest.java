...
public abstract class FilemodificationageFilterTest extends SingleRWeFileTest {
    protected void timeout(long milliseconds) {
        try {
            Thread.sleep(milliseconds);
        } catch (InterruptedException ex) {
            fail("InterruptedException occured");
        }
    }
}
