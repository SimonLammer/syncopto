...
public class MaxFilesizeFilter extends FilesizeFilter {
    private long maxFilesizeInBytes;

    public MaxFilesizeFilter(long maxFilesizeInBytes) {
        this.maxFilesizeInBytes = maxFilesizeInBytes;
    }

    @Override
    public boolean isSelected(File value) {
        return determineFilesizeInBytes(value) <= maxFilesizeInBytes;
    }
