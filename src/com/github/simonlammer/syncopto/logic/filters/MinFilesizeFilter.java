...
public class MinFilesizeFilter extends FilesizeFilter {
    private long minFilesizeInBytes;

    public MinFilesizeFilter(long minFilesizeInBytes) {
        this.minFilesizeInBytes = minFilesizeInBytes;
    }

    @Override
    public boolean isSelected(File value) {
        return determineFilesizeInBytes(value) >= minFilesizeInBytes;
    }
