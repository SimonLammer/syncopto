...
public class MaxFilemodificationageFilter extends FilemodificationageFilter {
    private long maxTimeInMilliseconds;

    public MaxFilemodificationageFilter(long maxTimeInMilliseconds) {
        this.maxTimeInMilliseconds = maxTimeInMilliseconds;
    }

    @Override
    public boolean isSelected(File value) {
        return determineFileage(value) <= maxTimeInMilliseconds;
    }
